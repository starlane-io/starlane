...
impl<Id, Entity> Clone for Stage<Id, Entity>
where
    Id: ArtifactLoc,
{
    fn clone(&self) -> Self {
...
impl<Id, Entity> Default for Stage<Id, Entity>
where
    Id: ArtifactLoc,
{
    fn default() -> Self {
...
impl<Id, Entity> Clone for Artifact<Id, Entity>
where
    Id: ArtifactLoc,
{
    fn clone(&self) -> Self {
...
impl<Id, Entity> Artifact<Id, Entity>
where
    Id: ArtifactLoc,
{
...
impl<Id, Entity> Deref for Artifact<Id, Entity>
where
    Id: ArtifactLoc,
{
    ...
    Self::Id: ArtifactLoc,
{
    ...
    fn try_ready(
        &self,
        id: Self::Id,
    ) -> Result<Option<Artifact<Self::Id, Self::Entity>>, CacheErr> {
