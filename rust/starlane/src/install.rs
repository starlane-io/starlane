...
use cliclack::{
    clear_screen, confirm, input, intro, outro, outro_cancel, select, set_theme, spinner, Confirm,
    Input, ProgressBar, Select, Theme, ThemeState, Validate,
};
...
"#
            ...
            if !customize {
                return Ok(PgRegistryConfig::Embedded(cfg));
            }
