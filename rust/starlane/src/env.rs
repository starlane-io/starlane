...
pub static STARLANE_CONTROL_PORT: Lazy<u16> = Lazy::new( || {std::env::var("STARLANE_PORT")
...
pub static STARLANE_REGISTRY_PASSWORD: Lazy<String> = Lazy::new( || {
    std::env::var("STARLANE_REGISTRY_PASSWORD").unwrap_or("password".to_string())});
pub static STARLANE_REGISTRY_DATABASE: Lazy<String> = Lazy::new( || {
