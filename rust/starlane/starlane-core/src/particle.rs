...
use cosmic_space::hyper::{AssignmentKind, ChildRegistry, Location};
use cosmic_space::id2::BaseSubKind;
use cosmic_space::kind::{ArtifactSubKind, BaseKind, FileSubKind, UserBaseSubKind};
use cosmic_space::loc::ToBaseKind;
use cosmic_space::loc::{StarKey, ToPoint};
use cosmic_space::parse::{consume_kind, CamelCase};
