...
use crate::version::v0_0_1::wave::{DirectedWave, Ping, Pong, ReflectedWave, UltraWave, Wave};
...
pub mod id {
    ...
    use crate::version::v0_0_1::wave::{Recipients, Ping, Pong, ToRecipients, Wave, UltraWave, DirectedWave, ReflectedWave, Exchanger};
