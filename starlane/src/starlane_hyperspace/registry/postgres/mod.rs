...
use starlane::space::command::direct::select::{
...
use crate::starlane_hyperspace::reg::{PgRegistryConfig, Registration, RegistryApi};
...
pub mod test {
    ...
    use crate::starlane_hyperspace::driver::DriversBuilder;
    use crate::err2::{HypErr, OldStarErr};
    use crate::starlane_hyperspace::hyperlane::{AnonHyperAuthenticator, LocalHyperwayGateJumper};
    use crate::starlane_hyperspace::err::HyperErr;
