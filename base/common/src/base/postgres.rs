...
/// Dependency and Providers of a particular Kind usually share some base traits regardless
...
/// A `base` trait definition for postgres might look like this:

/// Here we define the base config api for a Postgres Cluster instance
...
/// here we define the base attributes and api for every Postgres Provider (which in the case of Postgres is an actual Database in the Dependency cluster we created)
...
/// define the base Mode's of a Postgres Provider
pub mod mode {}


pub mod provider {
    //    use crate::base::base::postgres as my;
    mod my {
        pub use super::*;
    }
