...
import (
	...
	"github.com/mechtronium/starlane/controllers"
...
func init() {
	...
	utilruntime.Must(starlanev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "28f92ea4.starlane.io",
	})
	if err != nil {
	...
	if err = (&controllers.StarlaneReconciler{
	...
	if err = (&controllers.StarlaneProvisionerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
